...
import { Card } from "@/components/ui/card";
import { GraduationCap, Trophy, MapPin, Briefcase, Mail, CheckCircle } from "lucide-react";
    ...
    <section id="about" className="py-20 bg-gradient-to-br from-gray-50 to-white">
      <div className="container mx-auto px-6">
        ...
        <div className="bg-white rounded-3xl border border-gray-100 shadow-sm p-8 mb-8">
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-600 leading-relaxed">
                Passionate about building clean, scalable solutions and
                delivering real value. Currently{" "}
                <strong>open to full-time roles</strong> across India.
              </p>
              ...
              <div className="space-y-2 pt-2">
                <div className="flex items-center gap-3 text-gray-600 text-sm">
                  <Briefcase className="w-4 h-4 text-indigo-500 flex-shrink-0" />
                  <span><strong>Company:</strong> NearTekPod, Tiruchirappalli</span>
                </div>
                <div className="flex items-center gap-3 text-gray-600 text-sm">
                  <MapPin className="w-4 h-4 text-indigo-500 flex-shrink-0" />
            ...
            <div className="space-y-5">
              ...
              {/* Impact Metrics */}
              <div>
                <p className="text-sm font-medium text-gray-500 mb-3">Real Impact Delivered</p>
              ...
              {/* Key Skills */}
              <div>
                <p className="text-sm font-medium text-gray-500 mb-3">Core Tech Stack</p>
                <div className="flex flex-wrap gap-2">
                  {[
                    "React.js", "Next.js", "Node.js",
                    "WordPress", "PHP", "AWS",
                    "MongoDB", "MySQL", "TypeScript"
                  ].map((tech) => (
                    <span
                      key={tech}
                      className="text-xs bg-white text-indigo-600 border border-indigo-200 px-3 py-1.5 rounded-lg font-medium shadow-sm"
                    >
                      {tech}
                    </span>
                  ))}
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          {/* Experience Card */}
          <Card className="p-6 hover:shadow-xl transition-all duration-300 rounded-2xl border border-gray-100 hover:-translate-y-1">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">Feb 2024 – Mar 2025</p>
              </div>
            </div>
          ...
          <Card className="p-6 hover:shadow-xl transition-all duration-300 rounded-2xl border border-gray-100 hover:-translate-y-1">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-orange-600 font-semibold text-sm">CGPA: 8.70</span>
            </div>
          </Card>
          ...
          <Card className="p-6 hover:shadow-xl transition-all duration-300 rounded-2xl border border-gray-100 hover:-translate-y-1">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h4 className="font-semibold text-gray-800 text-sm">Certifications</h4>
                <p className="text-xs text-gray-500">4 completed</p>
              </div>
            </div>
            <div className="space-y-2">
              {[
                { color: "bg-red-500", text: "Oracle OCI Foundation" },
                { color: "bg-green-500", text: "MERN Stack — Simplilearn" },
                { color: "bg-orange-500", text: "AWS Cloud Basics — Simplilearn" },
                { color: "bg-purple-500", text: "PHP Fundamentals — Simplilearn" },
              ].map((cert) => (
                <div key={cert.text} className="flex items-center gap-2">
                  <span className={`w-2 h-2 ${cert.color} rounded-full flex-shrink-0`}></span>
                  <span className="text-xs text-gray-600">{cert.text}</span>
                </div>
              ))}
            </div>
          </Card>
